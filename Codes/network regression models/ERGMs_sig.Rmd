...
The coefficient on "nodematch.Goal" is 0.22229, statistically significant (p = 0.0269). This means that on this network, ties based on same Goal are **more likely** than ties based on not-same Goal. For Indonesia, indicators are more likely to be connected
with indicators under the same goal. -- we see some integration within goals. 
...
summary(gua)
```
coefficient = 0.06070, p = 0.576
**more likely**, NOT statistically significant
For Guatemala, indicators are a little bit more likely to be connected with indicators under the same goal, however, this relationship is not stable and reliable, may appear here just by chance -- less integration within goals, compared to Indonesia. 
...
**more likely**, NOT statistically significant (0.1 confidence level)
