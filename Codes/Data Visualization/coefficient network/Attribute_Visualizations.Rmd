...
```{r}
indo_attributes <- read.csv('https://raw.githubusercontent.com/PeishanLi/G5055_Practicum_Project2/main/Data/coefficient_network/indo_attributes.csv')
indo_attributes
gua_attributes <- read.csv('https://raw.githubusercontent.com/PeishanLi/G5055_Practicum_Project2/main/Data/coefficient_network/gua_attributes.csv')
gua_attributes
```
